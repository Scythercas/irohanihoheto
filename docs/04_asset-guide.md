...
| 手順 | 内容 |
|---|---|
| 1 | 画像の**外周から繋がっている白領域だけ**をたどって背景と判定する |
| 2 | 背景を透明にする |
| 3 | 輪郭の1〜2pxを半透明にして、ギザギザを防ぐ |
| 4 | 白が滲んだ縁の色を戻す（**白フチの除去**） |

**手順1が肝。** 単純に「白い画素を全部消す」方式だと**白いシャツまで消える**。
外周から繋がりでたどることで、カーディガンに囲まれたシャツは背景と繋がっていないため残る。
...
| **服の白い部分まで消えた** | その白領域が画像の縁と繋がっている。構図を見直すか、縁に1px枠を描いて分断する |
